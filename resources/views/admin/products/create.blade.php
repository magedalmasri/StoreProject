    ...
    <div class="py-3"  >
        <form action="{{url('products/store')}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="quantity" name="quantity" placeholder="ادخل الكمية">
            </div>
            <div class="mb-3">
                <label for="priceFormControlInput" class="form-label">السعر</label>
                <input type="number" class="form-control" id="price" name="price" placeholder="ادخل السعر">
            </div>
            <div class="mb-3">
